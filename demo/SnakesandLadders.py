# -*- coding: utf-8 -*-
"""
Created on Sun Sep 29 12:41:06 2019
...
# =============================================================================
    ...
    n= random.choice(id)
    print(n)
    c.execute('SELECT Question FROM Questions where QID is (?)', (n))
    que= c.fetchall()
    print("1." , que)
    
    c.execute('SELECT Option1 FROM Questions where QID is (?)', (n))
    opt1= c.fetchall()
    print("A. " ,opt1)
    
    c.execute('SELECT Option2 FROM Questions where QID is (?)', (n))
    opt2= c.fetchall()
    print("B. " ,opt2)
    
    c.execute('SELECT Option3 FROM Questions where QID is (?)', (n))
    opt3= c.fetchall()
    print("C. ",opt3)
    
    c.execute('SELECT Option4 FROM Questions where QID is (?)', (n))
    opt4= c.fetchall()
    print("D. ",opt4)
    
    c.execute('SELECT ANSWER FROM Questions where QID is (?)', (n))
    ans=c.fetchall()
    answer = ans[0][0]
